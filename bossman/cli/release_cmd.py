...
def init(subparsers: argparse._SubParsersAction):
  parser = subparsers.add_parser("release", help="release applicable resources")
  parser.add_argument("--rev", required=False, default="HEAD", help="commit id or git ref to release")
...
def exec(bossman: Bossman, rev, glob, *args, **kwargs):
  ...
  bossman.release(resources, revision)
